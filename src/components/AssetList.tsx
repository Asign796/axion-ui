...
export function AssetList({ devices, selectedDeviceId, onSelectDevice }: AssetListProps) {
  ...
  return (
    <div className="glass-card p-4 rounded-2xl animate-fade-up delay-300 flex flex-col h-[600px]">
      ...
      <div className="relative mb-3 px-2">
        ...
        <input
          type="text"
          className="w-full bg-slate-800/50 border border-slate-700/50 rounded-xl pl-10 pr-4 py-2 text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all"
